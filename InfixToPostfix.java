...
public class InfixToPostfix {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ekspresi Infix: " + infixExpression);
...
/*
 infix atau operasi matematikan biasa contoh 2 + 3
 postfix adalah operasi matematika dimana operator ditemaptkan setelah operan
 contoh 2 3 +
 */
